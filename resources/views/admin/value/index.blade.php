...
@section('page-name', 'Dashboard Admin | Value Setting')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="left-content">
            <h2 class="h3 mb-2 mt-4 page-title">Value Setting</h2>
        </div>
                            ...
                            @foreach ($value as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-3">
                                                <img class="text-center w-100 object-fit-cover rounded-circle p-3"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add Value</h5>
    ...
    @foreach ($value as $item)
        ...
        <div class="modal fade" id="basicModal-{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Edit Value</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="update-form" data-action="{{ url('/value/update/' . $item->id) }}" method="POST"
