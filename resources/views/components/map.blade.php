        ...
        .then(data => {
            if (Array.isArray(data)) {
                data.forEach((region, index) => {
                    simplemaps_worldmap_mapdata.locations[index] = {
                        lat: Math.round(region.latitude),
                        lng: Math.round(region.longitude),
                        name: region.name,
                        description: region.description || "Region description"
                    };
                });
            } else {
                console.error("Invalid data format received from /region");
            }
